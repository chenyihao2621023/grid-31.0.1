...
import { _, Autowired, Bean, PostConstruct, CssClassApplier } from '@/components/zing-grid/@zing-grid-community/core/main.js';
...
let ExcelCreator = class ExcelCreator extends BaseCreator {
  ...
  createSerializingSession(params) {
    ...
    const config = Object.assign(Object.assign({}, params), {
      sheetName,
      columnModel,
      valueService,
      gridOptionsService,
...
__decorate([Autowired('gridOptionsService')], ExcelCreator.prototype, "gridOptionsService", void 0);
__decorate([Autowired('valueFormatterService')], ExcelCreator.prototype, "valueFormatterService", void 0);
__decorate([Autowired('valueParserService')], ExcelCreator.prototype, "valueParserService", void 0);
