...
import { Bean, BeanStub, PreConstruct } from '@/components/zing-grid/@zing-grid-community/core/main.js';
...
__decorate([PreConstruct], GridLicenseManager.prototype, "validateLicense", null);
GridLicenseManager = __decorate([Bean('licenseManager')], GridLicenseManager);
