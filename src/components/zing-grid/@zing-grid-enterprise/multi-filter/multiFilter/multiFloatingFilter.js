...
export class MultiFloatingFilterComp extends Component {
  ...
  init(params) {
    ...
    const {
      compDetailsList
    } = this.getCompDetailsList(params);
  ...
  onParamsUpdated(params) {
    this.params = params;
    const {
      compDetailsList: newCompDetailsList,
      floatingFilterParamsList
    } = this.getCompDetailsList(params);
...
__decorate([Autowired('userComponentFactory')], MultiFloatingFilterComp.prototype, "userComponentFactory", void 0);
__decorate([Autowired('filterManager')], MultiFloatingFilterComp.prototype, "filterManager", void 0);