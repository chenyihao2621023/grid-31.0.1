...
import { Bean, BeanStub, ModuleNames, ModuleRegistry, Optional, _ } from '@/components/zing-grid/@zing-grid-community/core/main.js';
let ChartMenuItemMapper = ChartMenuItemMapper_1 = class ChartMenuItemMapper extends BeanStub {
  ...
  static filterAndOrderChartMenu(topLevelMenuItem, chartGroupsDef, configLookup) {
    ...
    let orderedAndFiltered = Object.assign(Object.assign({}, topLevelMenuItem), {
      subMenu: []
    });
