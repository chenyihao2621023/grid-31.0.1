...
export class GroupFilter extends TabGuardComp {
  ...
  createGroupFieldSelectElement(sourceColumns) {
    this.eGroupFieldSelect = this.createManagedBean(new ZingSelect());
  ...
  isFilterActive() {
    var _a;
    return !!((_a = this.filterColumnPairs) === null || _a === void 0 ? void 0 : _a.some(({
      filter
  ...
  getFilterColumnPair(columnId) {
    ...
    return (_a = this.filterColumnPairs) === null || _a === void 0 ? void 0 : _a.find(({
      column
