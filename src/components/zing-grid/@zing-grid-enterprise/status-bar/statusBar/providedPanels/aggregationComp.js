...
import { Autowired, Component, Events, PostConstruct, RefSelector, _, Optional } from '@/components/zing-grid/@zing-grid-community/core/main.js';
export class AggregationComp extends Component {
  ...
  getAggregationValueComponent(aggFuncName) {
    ...
    if (_.exists(aggregationPanelConfig) && aggregationPanelConfig) {
      if (!_.exists(aggregationPanelConfig.statusPanelParams) || _.exists(aggregationPanelConfig.statusPanelParams) && _.exists(aggregationPanelConfig.statusPanelParams.aggFuncs) && _.exists(aggregationPanelConfig.statusPanelParams.aggFuncs.find(func => func === aggFuncName))) {
