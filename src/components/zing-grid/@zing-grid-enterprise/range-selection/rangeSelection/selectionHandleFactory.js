...
import { Bean, BeanStub, SelectionHandleType } from "@/components/zing-grid/@zing-grid-community/core/main.js";
...
SelectionHandleFactory = __decorate([Bean('selectionHandleFactory')], SelectionHandleFactory);
