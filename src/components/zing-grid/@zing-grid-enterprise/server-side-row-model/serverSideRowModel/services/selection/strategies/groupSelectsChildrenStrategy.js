...
import { Autowired, BeanStub, PostConstruct, Events } from "@/components/zing-grid/@zing-grid-community/core/main.js";
  ...
  setNodesSelected(params) {
    ...
    if (params.rangeSelect) {
      ...
      routes.forEach(route => {
        ...
        this.recursivelySelectNode(route, this.selectedState, Object.assign({
          node
        }, other));
      });
      this.removeRedundantState();
    ...
    params.nodes.forEach(node => {
      ...
      this.recursivelySelectNode(idPathToNode, this.selectedState, Object.assign(Object.assign({}, other), {
        node
      }));
    });
    this.removeRedundantState();
...
__decorate([Autowired('rowModel')], GroupSelectsChildrenStrategy.prototype, "rowModel", void 0);
__decorate([Autowired('columnModel')], GroupSelectsChildrenStrategy.prototype, "columnModel", void 0);
__decorate([Autowired('filterManager')], GroupSelectsChildrenStrategy.prototype, "filterManager", void 0);
__decorate([Autowired('rowModel')], GroupSelectsChildrenStrategy.prototype, "serverSideRowModel", void 0);
__decorate([Autowired('selectionService')], GroupSelectsChildrenStrategy.prototype, "selectionService", void 0);
__decorate([PostConstruct], GroupSelectsChildrenStrategy.prototype, "init", null);