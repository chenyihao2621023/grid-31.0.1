...
export class AdvancedFilterBuilderItemComp extends TabGuardComp {
  ...
  postConstruct() {
    ...
    this.ePillWrapper.init({
      item: this.item,
      createPill: params => this.createPill(params)
    });
  ...
  createPill(params) {
    ...
    if (params.isSelect) {
      ...
      this.addManagedListener(comp, Events.EVENT_FIELD_PICKER_VALUE_SELECTED, ({
        value
      }) => onUpdated(value === null || value === void 0 ? void 0 : value.key));
      return comp;
    } else {
      ...
      this.addManagedListener(comp, Events.EVENT_FIELD_VALUE_CHANGED, ({
        value
      }) => onUpdated(value));
      return comp;
    }
...
__decorate([RefSelector('eTreeLines')], AdvancedFilterBuilderItemComp.prototype, "eTreeLines", void 0);
__decorate([RefSelector('eDragHandle')], AdvancedFilterBuilderItemComp.prototype, "eDragHandle", void 0);
__decorate([RefSelector('eItem')], AdvancedFilterBuilderItemComp.prototype, "eItem", void 0);
__decorate([RefSelector('eButtons')], AdvancedFilterBuilderItemComp.prototype, "eButtons", void 0);
__decorate([RefSelector('eValidation')], AdvancedFilterBuilderItemComp.prototype, "eValidation", void 0);
__decorate([RefSelector('eMoveUpButton')], AdvancedFilterBuilderItemComp.prototype, "eMoveUpButton", void 0);
__decorate([RefSelector('eMoveDownButton')], AdvancedFilterBuilderItemComp.prototype, "eMoveDownButton", void 0);
__decorate([RefSelector('eAddButton')], AdvancedFilterBuilderItemComp.prototype, "eAddButton", void 0);
__decorate([RefSelector('eRemoveButton')], AdvancedFilterBuilderItemComp.prototype, "eRemoveButton", void 0);
__decorate([Autowired('beans')], AdvancedFilterBuilderItemComp.prototype, "beans", void 0);
__decorate([Autowired('dragAndDropService')], AdvancedFilterBuilderItemComp.prototype, "dragAndDropService", void 0);
__decorate([Autowired('advancedFilterExpressionService')], AdvancedFilterBuilderItemComp.prototype, "advancedFilterExpressionService", void 0);
__decorate([PostConstruct], AdvancedFilterBuilderItemComp.prototype, "postConstruct", null);