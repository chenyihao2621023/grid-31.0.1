...
export class AdvancedFilterComp extends Component {
  ...
  postConstruct() {
    ...
    this.refresh();
    this.addManagedListener(this.eAutocomplete, ZingAutocomplete.EVENT_VALUE_CHANGED, ({
      value
    }) => this.onValueChanged(value));
    this.addManagedListener(this.eAutocomplete, ZingAutocomplete.EVENT_VALUE_CONFIRMED, ({
      isValid
    }) => this.onValueConfirmed(isValid));
    this.addManagedListener(this.eAutocomplete, ZingAutocomplete.EVENT_OPTION_SELECTED, ({
      position,
      updateEntry,
      autocompleteType
    }) => this.onOptionSelected(position, updateEntry, autocompleteType));
    this.addManagedListener(this.eAutocomplete, ZingAutocomplete.EVENT_VALID_CHANGED, ({
      isValid,
      validationMessage
  ...
  refresh() {
    ...
    this.eAutocomplete.setValue({
      value: expression !== null && expression !== void 0 ? expression : '',
      position: expression === null || expression === void 0 ? void 0 : expression.length,
...
__decorate([RefSelector('eAutocomplete')], AdvancedFilterComp.prototype, "eAutocomplete", void 0);
__decorate([RefSelector('eApplyFilterButton')], AdvancedFilterComp.prototype, "eApplyFilterButton", void 0);
__decorate([RefSelector('eBuilderFilterButton')], AdvancedFilterComp.prototype, "eBuilderFilterButton", void 0);
__decorate([RefSelector('eBuilderFilterButtonIcon')], AdvancedFilterComp.prototype, "eBuilderFilterButtonIcon", void 0);
__decorate([RefSelector('eBuilderFilterButtonLabel')], AdvancedFilterComp.prototype, "eBuilderFilterButtonLabel", void 0);
__decorate([Autowired('advancedFilterService')], AdvancedFilterComp.prototype, "advancedFilterService", void 0);
__decorate([Autowired('advancedFilterExpressionService')], AdvancedFilterComp.prototype, "advancedFilterExpressionService", void 0);
__decorate([Autowired('filterManager')], AdvancedFilterComp.prototype, "filterManager", void 0);
__decorate([PostConstruct], AdvancedFilterComp.prototype, "postConstruct", null);