  ...
  setModel(model) {
    const parseModel = (model, isFirstParent) => {
      if (model.filterType === 'join') {
        ...
        const expression = model.conditions.map(condition => parseModel(condition)).filter(condition => _.exists(condition)).join(` ${operator} `);
...
__decorate([Autowired('valueService')], AdvancedFilterService.prototype, "valueService", void 0);
__decorate([Autowired('columnModel')], AdvancedFilterService.prototype, "columnModel", void 0);
__decorate([Autowired('dataTypeService')], AdvancedFilterService.prototype, "dataTypeService", void 0);
__decorate([Autowired('valueParserService')], AdvancedFilterService.prototype, "valueParserService", void 0);
__decorate([Autowired('rowModel')], AdvancedFilterService.prototype, "rowModel", void 0);
__decorate([Autowired('advancedFilterExpressionService')], AdvancedFilterService.prototype, "advancedFilterExpressionService", void 0);
__decorate([PostConstruct], AdvancedFilterService.prototype, "postConstruct", null);
AdvancedFilterService = __decorate([Bean('advancedFilterService')], AdvancedFilterService);
