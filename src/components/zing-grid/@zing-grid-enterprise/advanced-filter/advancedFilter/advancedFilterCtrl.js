...
export class AdvancedFilterCtrl extends BeanStub {
  ...
  toggleFilterBuilder(source, force) {
    ...
    this.eBuilderDialog = this.createBean(new ZingDialog({
      ...
      afterGuiAttached: () => {
        var _a;
        return (_a = this.eBuilderComp) === null || _a === void 0 ? void 0 : _a.afterGuiAttached();
      }
    }));
  ...
  getBuilderDialogSize() {
    ...
    const maxWidth = Math.round(_.getAbsoluteWidth(popupParent)) - 2;
...
__decorate([Autowired('focusService')], AdvancedFilterCtrl.prototype, "focusService", void 0);
__decorate([Autowired('ctrlsService')], AdvancedFilterCtrl.prototype, "ctrlsService", void 0);
__decorate([Autowired('popupService')], AdvancedFilterCtrl.prototype, "popupService", void 0);
__decorate([Autowired('advancedFilterExpressionService')], AdvancedFilterCtrl.prototype, "advancedFilterExpressionService", void 0);
__decorate([PostConstruct], AdvancedFilterCtrl.prototype, "postConstruct", null);