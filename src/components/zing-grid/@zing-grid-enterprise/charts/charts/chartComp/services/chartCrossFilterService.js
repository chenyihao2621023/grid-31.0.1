...
let ChartCrossFilterService = ChartCrossFilterService_1 = class ChartCrossFilterService extends BeanStub {
  filter(event, reset = false) {
    ...
    if (this.isValidColumnFilter(colId)) {
      ...
      console.warn("ZING Grid: cross filtering requires a 'zingSetColumnFilter' or 'zingMultiColumnFilter' " + "to be defined on the column with id: '" + colId + "'");
    }
  }
  ...
  updateFilters(filterModel, event, colId) {
    ...
    if (event.event.metaKey || event.event.ctrlKey) {
      ...
      filterModel = {
        [colId]: this.getUpdatedFilterModel(colId, updatedValues)
      };
    }
...
__decorate([Autowired('gridApi')], ChartCrossFilterService.prototype, "gridApi", void 0);
__decorate([Autowired('columnModel')], ChartCrossFilterService.prototype, "columnModel", void 0);
__decorate([Autowired('valueService')], ChartCrossFilterService.prototype, "valueService", void 0);
ChartCrossFilterService = ChartCrossFilterService_1 = __decorate([Bean("chartCrossFilterService")], ChartCrossFilterService);
