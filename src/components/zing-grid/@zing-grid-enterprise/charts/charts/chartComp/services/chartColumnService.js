...
let ChartColumnService = class ChartColumnService extends BeanStub {
  ...
  isNumberCol(col) {
    ...
    const row = this.rowRenderer.getRowNode({
      rowIndex: 0,
      rowPinned: null
    });
    if (!row) {
...
__decorate([Autowired('columnModel')], ChartColumnService.prototype, "columnModel", void 0);
__decorate([Autowired('valueService')], ChartColumnService.prototype, "valueService", void 0);
__decorate([Autowired('rowRenderer')], ChartColumnService.prototype, "rowRenderer", void 0);
ChartColumnService = __decorate([Bean("chartColumnService")], ChartColumnService);
