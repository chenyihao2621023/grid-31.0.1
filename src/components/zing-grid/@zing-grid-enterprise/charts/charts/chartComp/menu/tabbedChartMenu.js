  ...
  init() {
    this.panels.forEach(panel => {
      ...
      const {
        comp,
        tab
      } = this.createTab(panel, panelType, this.getPanelClass(panelType));
      this.tabs.push(tab);
...
__decorate([Autowired('chartTranslationService')], TabbedChartMenu.prototype, "chartTranslationService", void 0);
__decorate([PostConstruct], TabbedChartMenu.prototype, "init", null);