...
export class UpdateParamsValidator {
  ...
  static validateUpdateRangeChartParams(params) {
    const validations = [...UpdateParamsValidator.commonValidations, ...UpdateParamsValidator.cellRangeValidations, {
  ...
  static validateUpdatePivotChartParams(params) {
    const validations = [...UpdateParamsValidator.commonValidations];
...
UpdateParamsValidator.validChartTypes = ['column', 'groupedColumn', 'stackedColumn', 'normalizedColumn', 'bar', 'groupedBar', 'stackedBar', 'normalizedBar', 'line', 'scatter', 'bubble', 'pie', 'doughnut', 'area', 'stackedArea', 'normalizedArea', 'histogram', 'columnLineCombo', 'areaColumnCombo', 'customCombo'];
...
UpdateParamsValidator.commonValidations = [{
  ...
  warnMessage: createWarnMessage('chartId', 'string')
}, {
  property: 'chartType',
  ...
  warnMessage: createWarnMessage('unlinkChart', 'boolean')
}];
