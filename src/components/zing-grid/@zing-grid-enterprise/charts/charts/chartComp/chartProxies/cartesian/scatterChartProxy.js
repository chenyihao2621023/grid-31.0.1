...
export class ScatterChartProxy extends CartesianChartProxy {
  ...
  extractCrossFilterSeries(series, params) {
    ...
    const updatePrimarySeries = (series, idx) => {
      ...
      const marker = Object.assign(Object.assign({}, series.marker), {
        fill,
        stroke,
        domain: markerDomain
      });
      return Object.assign(Object.assign({}, series), {
        ...
        listeners: Object.assign(Object.assign({}, series.listeners), {
    ...
    const updateFilteredOutSeries = series => {
      ...
      if (series.type === 'bubble') {
        alteredSizeKey = {
          sizeKey: filteredOutKey(series.sizeKey)
        };
      }
      return Object.assign(Object.assign(Object.assign({}, series), alteredSizeKey), {
        ...
        listeners: Object.assign(Object.assign({}, series.listeners), {
          nodeClick: e => {
            ...
            const filterableEvent = Object.assign(Object.assign({}, e), {
              xKey,
              datum: Object.assign(Object.assign({}, e.datum), {
                [xKey]: value
              })
            });
  ...
  getSeriesDefinitions(fields, paired) {
    ...
    return fields.filter((value, i) => i > 0).map(yField => ({
      xField,
      yField
    }));
  }
