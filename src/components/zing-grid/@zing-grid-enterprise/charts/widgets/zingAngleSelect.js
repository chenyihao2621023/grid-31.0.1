...
import { Autowired, Events, ZingAbstractLabel, RefSelector, _ } from "@/components/zing-grid/@zing-grid-community/core/main.js";
export class ZingAngleSelect extends ZingAbstractLabel {
  constructor(config) {
    super(config, ZingAngleSelect.TEMPLATE);
    this.radius = 0;
    this.offsetX = 0;
    this.offsetY = 0;
  }
  postConstruct() {
    ...
    this.eAngleValue.setLabel('').setLabelWidth(5).setInputWidth(45).setMin(0).setMax(360).setValue(`${this.degrees}`).onValueChange(value => {
      if (value == null || value === '') {
        value = '0';
      }
...
__decorate([RefSelector('eLabel')], ZingAngleSelect.prototype, "eLabel", void 0);
__decorate([RefSelector('eParentCircle')], ZingAngleSelect.prototype, "eParentCircle", void 0);
__decorate([RefSelector('eChildCircle')], ZingAngleSelect.prototype, "eChildCircle", void 0);
__decorate([RefSelector('eAngleValue')], ZingAngleSelect.prototype, "eAngleValue", void 0);
__decorate([Autowired('dragService')], ZingAngleSelect.prototype, "dragService", void 0);