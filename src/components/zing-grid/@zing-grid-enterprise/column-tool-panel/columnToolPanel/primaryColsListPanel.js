...
import { _, Autowired, Component, Events, ProvidedColumnGroup, VirtualList, PreDestroy } from "@/components/zing-grid/@zing-grid-community/core/main.js";
...
export class PrimaryColsListPanel extends Component {
  ...
  init(params, allowDragging, eventType) {
    ...
    const eventsImpactingCheckedState = [Events.EVENT_COLUMN_PIVOT_CHANGED, Events.EVENT_COLUMN_PIVOT_MODE_CHANGED, Events.EVENT_COLUMN_ROW_GROUP_CHANGED, Events.EVENT_COLUMN_VALUE_CHANGED, Events.EVENT_COLUMN_VISIBLE, Events.EVENT_NEW_COLUMNS_LOADED];
