...
const { Label } = _Scene;
const { BaseProperties, HierarchySeriesProperties, HighlightStyle, SeriesTooltip, Validate, BOOLEAN, COLOR_STRING, FUNCTION, NUMBER, OBJECT, POSITIVE_NUMBER, RATIO, STRING, STRING_ARRAY, TEXT_ALIGN, VERTICAL_ALIGN, } = _ModuleSupport;
...
__decorate([
    Validate(OBJECT)
], TreemapSeriesGroup.prototype, "label", void 0);
...
__decorate([
    Validate(OBJECT)
], TreemapSeriesTile.prototype, "label", void 0);
__decorate([
    Validate(OBJECT)
], TreemapSeriesTile.prototype, "secondaryLabel", void 0);
...
__decorate([
    Validate(OBJECT)
], TreemapSeriesGroupHighlightStyle.prototype, "label", void 0);
...
__decorate([
    Validate(OBJECT)
], TreemapSeriesTileHighlightStyle.prototype, "label", void 0);
__decorate([
    Validate(OBJECT)
], TreemapSeriesTileHighlightStyle.prototype, "secondaryLabel", void 0);
...
__decorate([
    Validate(OBJECT)
], TreemapSeriesHighlightStyle.prototype, "group", void 0);
__decorate([
    Validate(OBJECT)
], TreemapSeriesHighlightStyle.prototype, "tile", void 0);
...
__decorate([
    Validate(OBJECT)
], TreemapSeriesProperties.prototype, "highlightStyle", void 0);
__decorate([
    Validate(OBJECT)
], TreemapSeriesProperties.prototype, "tooltip", void 0);
__decorate([
    Validate(OBJECT)
], TreemapSeriesProperties.prototype, "group", void 0);
__decorate([
    Validate(OBJECT)
], TreemapSeriesProperties.prototype, "tile", void 0);
__decorate([
    Validate(STRING_ARRAY)
], TreemapSeriesProperties.prototype, "undocumentedGroupFills", void 0);
__decorate([
    Validate(STRING_ARRAY)
