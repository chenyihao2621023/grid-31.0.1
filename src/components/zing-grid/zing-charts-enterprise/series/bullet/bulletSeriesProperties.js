...
const { BaseProperties, AbstractBarSeriesProperties, PropertiesArray, SeriesTooltip, Validate, ARRAY, COLOR_STRING, LINE_DASH, OBJECT, POSITIVE_NUMBER, RATIO, STRING, } = _ModuleSupport;
...
__decorate([
    Validate(STRING)
], BulletSeriesProperties.prototype, "valueKey", void 0);
__decorate([
...
__decorate([
    Validate(COLOR_STRING)
], BulletSeriesProperties.prototype, "fill", void 0);
__decorate([
    Validate(RATIO)
], BulletSeriesProperties.prototype, "fillOpacity", void 0);
__decorate([
    Validate(COLOR_STRING)
], BulletSeriesProperties.prototype, "stroke", void 0);
__decorate([
    Validate(POSITIVE_NUMBER)
], BulletSeriesProperties.prototype, "strokeWidth", void 0);
__decorate([
    Validate(RATIO)
], BulletSeriesProperties.prototype, "strokeOpacity", void 0);
__decorate([
    Validate(LINE_DASH)
], BulletSeriesProperties.prototype, "lineDash", void 0);
__decorate([
    Validate(POSITIVE_NUMBER)
], BulletSeriesProperties.prototype, "lineDashOffset", void 0);
__decorate([
    Validate(RATIO)
], BulletSeriesProperties.prototype, "widthRatio", void 0);
__decorate([
    Validate(ARRAY.restrict({ minLength: 1 }))
], BulletSeriesProperties.prototype, "colorRanges", void 0);
__decorate([
    Validate(OBJECT)
], BulletSeriesProperties.prototype, "target", void 0);
__decorate([
    Validate(OBJECT)
], BulletSeriesProperties.prototype, "scale", void 0);
__decorate([
    Validate(OBJECT)
