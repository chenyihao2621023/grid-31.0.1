...
const STYLING_KEYS = ['fill', 'fillOpacity', 'stroke', 'strokeWidth', 'strokeOpacity', 'lineDash', 'lineDashOffset'];
export class BulletSeries extends _ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    ...
    this.colorRangesGroup = new _Scene.Group({
      name: `${this.id}-colorRanges`
    });
  ...
  processData(dataController) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (targetKey !== undefined) {
        extraProps.push(valueProperty(this, targetKey, isContinuousY, {
          id: 'target'
        }));
      }
      ...
      yield this.requestDataModel(dataController, this.data.slice(0, 1), {
        props: [keyProperty(this, valueKey, isContinuousX, {
          id: 'xValue'
        }), valueProperty(this, valueKey, isContinuousY, {
          id: 'value'
        }), ...extraProps],
        groupByKeys: true,
  ...
  createNodeData() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (const {
        ...
        const nodeData = Object.assign(Object.assign({
          series: this,
          datum: datum[0],
          xKey: valueKey,
          xValue,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const content = targetKey === undefined || targetValue === undefined ? makeLine(valueKey, valueName, valueValue) : `${makeLine(valueKey, valueName, valueValue)}<br/>${makeLine(targetKey, targetName, targetValue)}`;
    return this.properties.tooltip.toTooltipHtml({
      title,
      content,
      backgroundColor: this.properties.fill
    }, {
      datum,
      title,
      seriesId: this.id,
  ...
  updateColorRanges() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const computeRect = this.getBarDirection() === _ModuleSupport.ChartAxisDirection.Y ? (rect, colorRange) => {
        rect.x = min;
