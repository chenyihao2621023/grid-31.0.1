...
export class RadialBarSeries extends _ModuleSupport.PolarSeries {
  ...
  processData(dataController) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const visibleProps = this.visible || !animationEnabled ? {} : {
        forceValue: 0
      };
      yield this.requestDataModel(dataController, (_a = this.data) !== null && _a !== void 0 ? _a : [], {
        props: [keyProperty(this, radiusKey, false, {
          id: 'radiusValue'
        }), valueProperty(this, angleKey, true, Object.assign({
          id: 'angleValue-raw',
          invalidValue: null
        }, visibleProps)), ...groupAccumulativeValueProperty(this, angleKey, true, 'normal', 'current', Object.assign({
          id: `angleValue-end`,
          invalidValue: null,
          groupId: stackGroupId
        }, visibleProps)), ...groupAccumulativeValueProperty(this, angleKey, true, 'trailing', 'current', Object.assign({
          id: `angleValue-start`,
          invalidValue: null,
  ...
  createNodeData() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const nodeData = processedData.data.map((group, index) => {
        ...
        const labelNodeDatum = this.properties.label.enabled ? getLabelNodeDatum(datum, angleDatum, x, y) : undefined;
        return {
          series: this,
          datum,
          point: {
