...
export class RadialColumnSeriesBase extends _ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    ...
    super({
      ...
      useLabelLayer: true,
      canHaveAxes: true,
      animationResetFns: Object.assign(Object.assign({}, animationResetFns), {
        label: resetLabelFn
      })
    });
  ...
  processData(dataController) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const visibleProps = visible || !animationEnabled ? {} : {
        forceValue: 0
      };
      yield this.requestDataModel(dataController, (_a = this.data) !== null && _a !== void 0 ? _a : [], {
        props: [keyProperty(this, angleKey, false, {
          id: 'angleValue'
        }), valueProperty(this, radiusKey, true, Object.assign({
          id: 'radiusValue-raw',
          invalidValue: null
        }, visibleProps)), ...groupAccumulativeValueProperty(this, radiusKey, true, 'normal', 'current', Object.assign({
          id: `radiusValue-end`,
          invalidValue: null,
          groupId: stackGroupId
        }, visibleProps)), ...groupAccumulativeValueProperty(this, radiusKey, true, 'trailing', 'current', Object.assign({
          id: `radiusValue-start`,
          invalidValue: null,
          groupId: stackGroupTrailingId
        }, visibleProps)), ...extraProps],
  ...
  createNodeData() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      groupScale.domain = Array.from({
        length: visibleGroupCount
      }).map((_, i) => String(i));
      ...
      const nodeData = processedData.data.map((group, index) => {
        ...
        const labelNodeDatum = this.properties.label.enabled ? getLabelNodeDatum(datum, radiusDatum, x, y) : undefined;
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const {
      fill: color
    } = (_a = formatter && this.ctx.callbackCache.call(formatter, {
      seriesId,
      datum,
      fill,
      stroke,
