...
export class SunburstSeries extends _ModuleSupport.HierarchySeries {
  ...
  processData() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.labelData = Array.from(this.rootNode, ({
        datum,
        depth
      }) => {
        let label;
  ...
  updateNodes() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sizeFittingHeight = height => {
          ...
          if (isCenterCircle) {
            ...
            return {
              width,
              height,
              meta: LabelPlacement.CenterCircle
            };
          }
          ...
          if (depth === 0) {
            ...
            perpendicularWidth = Math.sqrt(Math.pow(outerRadius, 2) - Math.pow(perpendicularHeight / 2, 2)) - height / (2 * Math.tan(deltaOuterAngle * 0.5));
          } else {
          ...
          return parallelWidth >= perpendicularWidth ? {
            ...
            meta: LabelPlacement.Parallel
          } : {
            width: perpendicularWidth,
            height: perpendicularHeight,
            meta: LabelPlacement.Perpendicular
          };
        };
        const formatting = formatLabels(labelDatum === null || labelDatum === void 0 ? void 0 : labelDatum.label, this.properties.label, labelDatum === null || labelDatum === void 0 ? void 0 : labelDatum.secondaryLabel, this.properties.secondaryLabel, {
          padding
        }, sizeFittingHeight);
      ...
      const updateText = (node, text, tag, highlighted) => {
        ...
        if (highlighted) {
          const highlightedLabelStyle = tag === TextNodeTag.Primary ? this.properties.highlightStyle.label : this.properties.highlightStyle.secondaryLabel;
          ...
          case LabelPlacement.Perpendicular:
            {
              ...
              const translation = tag === TextNodeTag.Primary === !rightHalf ? (height - label.height) * 0.5 : (label.height - height) * 0.5;
              text.textAlign = 'center';
