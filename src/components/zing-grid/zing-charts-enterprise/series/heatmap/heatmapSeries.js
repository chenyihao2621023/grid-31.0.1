...
export class HeatmapSeries extends _ModuleSupport.CartesianSeries {
  ...
  processData(dataController) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const {
        ...
        props: [valueProperty(this, xKey, isContinuousX, {
          id: 'xValue'
  ...
  createNodeData() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (const {
        values,
        datum
      } of (_f = (_e = this.processedData) === null || _e === void 0 ? void 0 : _e.data) !== null && _f !== void 0 ? _f : []) {
        ...
        const labels = formatLabels(labelText, this.properties.label, undefined, this.properties.label, {
          padding: itemPadding
        }, sizeFittingHeight);
        const point = {
          x,
  ...
  updateDatumNodes(opts) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      opts.datumSelection.each((rect, datum) => {
        ...
        const fill = isDatumHighlighted && highlightedFill !== undefined ? Color.interpolate(datum.fill, highlightedFill)(highlightedFillOpacity !== null && highlightedFillOpacity !== void 0 ? highlightedFillOpacity : 1) : datum.fill;
        const stroke = isDatumHighlighted && highlightedStroke !== undefined ? highlightedStroke : this.properties.stroke;
        const strokeWidth = isDatumHighlighted && highlightedDatumStrokeWidth !== undefined ? highlightedDatumStrokeWidth : this.properties.strokeWidth;
        let format;
        if (formatter) {
  ...
  getLegendData(legendType) {
    var _a;
    if (legendType !== 'gradient' || !((_a = this.data) === null || _a === void 0 ? void 0 : _a.length) || !this.properties.isValid() || !this.isColorScaleValid() || !this.dataModel) {
      return [];
    }
    return [{
      legendType: 'gradient',
