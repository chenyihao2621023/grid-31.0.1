...
export class RadarSeries extends _ModuleSupport.PolarSeries {
  ...
  processData(dataController) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.requestDataModel(dataController, (_a = this.data) !== null && _a !== void 0 ? _a : [], {
        props: [valueProperty(this, angleKey, false, {
          id: 'angleValue'
        }), valueProperty(this, radiusKey, false, {
          id: 'radiusValue',
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const {
      fill: color
    } = (_a = markerFormatter && this.ctx.callbackCache.call(markerFormatter, {
      datum,
      angleKey,
      radiusKey,
      fill,
  ...
  getLinePoints() {
    ...
    if (firstValid !== undefined) {
      points.push({
        x: firstValid.point.x,
        y: firstValid.point.y,
        moveTo: false
      });
    }
    return points;
  ...
  animateSinglePath(pathNode, points, ratio) {
    ...
    const radiusAxis = this.axes[ChartAxisDirection.Y];
    const reversedRadiusAxis = radiusAxis === null || radiusAxis === void 0 ? void 0 : radiusAxis.isReversed();
    const radiusZero = reversedRadiusAxis ? this.radius + axisInnerRadius - (radiusAxis === null || radiusAxis === void 0 ? void 0 : radiusAxis.scale.convert(0)) : axisInnerRadius;
  ...
  animateEmptyUpdateReady() {
    ...
    animationManager.animate(Object.assign(Object.assign({
      id: `${this.id}_'path`,
      groupId: this.id
    }, animationOptions), {
      duration,
