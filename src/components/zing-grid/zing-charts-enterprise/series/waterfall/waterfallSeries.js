...
export class WaterfallSeries extends _ModuleSupport.AbstractBarSeries {
  ...
  processData(dataController) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      data.forEach((datum, i) => {
        ...
        (_a = totalsMap.get(i)) === null || _a === void 0 ? void 0 : _a.forEach(total => dataWithTotals.push(Object.assign(Object.assign({}, total.toJson()), {
      ...
      const {
        ...
        props: [keyProperty(this, xKey, isContinuousX, {
          id: `xValue`
        }), accumulativeValueProperty(this, yKey, true, Object.assign(Object.assign({}, propertyDefinition), {
          id: `yCurrent`
        })), accumulativeValueProperty(this, yKey, true, Object.assign(Object.assign({}, propertyDefinition), {
          missingValue: 0,
          id: `yCurrentTotal`
        ...
        })), trailingAccumulatedValueProperty(this, yKey, true, Object.assign(Object.assign({}, propertyDefinition), {
          id: `yPrevious`
        })), valueProperty(this, yKey, true, {
          id: `yRaw`
        }), valueProperty(this, 'totalType', false, {
          id: `totalTypeValue`,
          missingValue: undefined,
          validation: totalTypeValue
        }), ...(isContinuousX ? [_ModuleSupport.SMALLEST_KEY_INTERVAL] : []), ...extraProps],
  ...
  getSeriesDomain(direction) {
    ...
    const {
      ...
      reduced: {
        [_ModuleSupport.SMALLEST_KEY_INTERVAL.property]: smallestX
      } = {}
    } = processedData;
  ...
  createNodeData() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      (_c = this.processedData) === null || _c === void 0 ? void 0 : _c.data.forEach(({
        keys,
        datum,
        values
      }, dataIndex) => {
        ...
        const {
          cumulativeValue,
          trailingValue
        } = getValues(isTotal, isSubtotal, values);
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const content = `<b>${sanitizeHtml(xName !== null && xName !== void 0 ? xName : xKey)}</b>: ${xString}<br/>` + `<b>${sanitizeHtml(ySubheading)}</b>: ${yString}`;
  ...
  getLegendData(legendType) {
    ...
    seriesItemTypes.forEach(item => {
      ...
      legendData.push({
        ...
        enabled: true,
        label: {
          text: name !== null && name !== void 0 ? name : capitalise(item)
        },
        marker: {
          fill,
          stroke,
