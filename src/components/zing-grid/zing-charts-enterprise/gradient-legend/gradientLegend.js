...
__decorate([Validate(POSITIVE_NUMBER)], GradientBar.prototype, "thickness", void 0);
__decorate([Validate(POSITIVE_NUMBER)], GradientBar.prototype, "preferredLength", void 0);
...
__decorate([Validate(MIN_SPACING), Default(NaN)], GradientLegendAxisTick.prototype, "maxSpacing", void 0);
...
__decorate([ProxyProperty('label', 'fontStyle')], GradientLegendLabel.prototype, "fontStyle", void 0);
__decorate([ProxyProperty('label', 'fontWeight')], GradientLegendLabel.prototype, "fontWeight", void 0);
__decorate([ProxyProperty('label', 'fontSize')], GradientLegendLabel.prototype, "fontSize", void 0);
__decorate([ProxyProperty('label', 'fontFamily')], GradientLegendLabel.prototype, "fontFamily", void 0);
__decorate([ProxyProperty('label', 'color')], GradientLegendLabel.prototype, "color", void 0);
__decorate([ProxyProperty('label', 'format')], GradientLegendLabel.prototype, "format", void 0);
__decorate([ProxyProperty('label', 'formatter')], GradientLegendLabel.prototype, "formatter", void 0);
class GradientLegendInterval {
  constructor(tick) {
    this.tick = tick;
  }
}
__decorate([ProxyProperty('tick', 'values')], GradientLegendInterval.prototype, "values", void 0);
__decorate([ProxyProperty('tick', 'minSpacing')], GradientLegendInterval.prototype, "minSpacing", void 0);
__decorate([ProxyProperty('tick', 'maxSpacing')], GradientLegendInterval.prototype, "maxSpacing", void 0);
__decorate([ProxyProperty('tick', 'interval')], GradientLegendInterval.prototype, "step", void 0);
...
__decorate([ProxyProperty('axis', 'seriesAreaPadding')], GradientLegendScale.prototype, "padding", void 0);
export class GradientLegend {
  ...
  constructor(ctx) {
    ...
    this.axisGridGroup = new Group({
      name: 'legend-axis-grid-group'
    });
    this.group.append(this.axisGridGroup);
    this.axisGroup = new Group({
      name: 'legend-axis-group'
    });
  ...
  update(shrinkRect) {
    ...
    if (!this.enabled || !data || !data.enabled) {
      ...
      return {
        shrinkRect: shrinkRect.clone()
      };
    }
    const {
      colorRange
    } = this.normalizeColorArrays(data);
    ...
    const {
      ...
      translateX,
      translateY
    } = this.getMeasurements(shrinkRect, gradientBox, axisBox);
  ...
  updateGradientRect(shrinkRect, colorRange) {
    const {
      preferredLength: gradientLength,
      thickness
    } = this.gradient;
...
__decorate([Validate(BOOLEAN)], GradientLegend.prototype, "enabled", void 0);
__decorate([Validate(POSITION)], GradientLegend.prototype, "position", void 0);
__decorate([Validate(BOOLEAN, {
  optional: true
})], GradientLegend.prototype, "reverseOrder", void 0);
__decorate([Validate(POSITIVE_NUMBER)], GradientLegend.prototype, "spacing", void 0);
__decorate([DeprecatedAndRenamedTo('scale')], GradientLegend.prototype, "stop", void 0);