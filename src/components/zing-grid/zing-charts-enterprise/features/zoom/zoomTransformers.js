...
export function unitZoomState() {
  return {
    x: Object.assign({}, UNIT),
    y: Object.assign({}, UNIT)
  };
}
export function definedZoomState(zoom) {
  ...
  return {
    x: {
      min: (_b = (_a = zoom === null || zoom === void 0 ? void 0 : zoom.x) === null || _a === void 0 ? void 0 : _a.min) !== null && _b !== void 0 ? _b : UNIT.min,
      max: (_d = (_c = zoom === null || zoom === void 0 ? void 0 : zoom.x) === null || _c === void 0 ? void 0 : _c.max) !== null && _d !== void 0 ? _d : UNIT.max
    },
    y: {
      min: (_f = (_e = zoom === null || zoom === void 0 ? void 0 : zoom.y) === null || _e === void 0 ? void 0 : _e.min) !== null && _f !== void 0 ? _f : UNIT.min,
      max: (_h = (_g = zoom === null || zoom === void 0 ? void 0 : zoom.y) === null || _g === void 0 ? void 0 : _g.max) !== null && _h !== void 0 ? _h : UNIT.max
    }
  };
}
...
export function scaleZoom(zoom, sx, sy) {
  ...
  return {
    x: {
      min: zoom.x.min,
      max: zoom.x.min + dx * sx
    },
    y: {
      min: zoom.y.min,
      max: zoom.y.min + dy * sy
    }
  };
}
