...
export class Crosshair extends _ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    ...
    this.destroyFns.push(ctx.interactionManager.addListener('hover', event => this.onMouseMove(event)), ctx.interactionManager.addListener('leave', () => this.onMouseOut()), ctx.highlightManager.addListener('highlight-change', event => this.onHighlightChange(event)), ctx.layoutService.addListener('layout-complete', event => this.layout(event)), () => {
      var _a;
      return (_a = ctx.scene.root) === null || _a === void 0 ? void 0 : _a.removeChild(this.crosshairGroup);
    }, () => this.label.destroy());
  }
  layout({
    series: {
  ...
  onHighlightChange(event) {
    ...
    const hasCrosshair = (currentHighlight === null || currentHighlight === void 0 ? void 0 : currentHighlight.datum) && (((_a = currentHighlight.series.axes.x) === null || _a === void 0 ? void 0 : _a.id) === axisCtx.axisId || ((_b = currentHighlight.series.axes.y) === null || _b === void 0 ? void 0 : _b.id) === axisCtx.axisId);
    if (!hasCrosshair) {
      this.activeHighlight = undefined;
    } else {
    ...
    if (visible && this.activeHighlight) {
      ...
      const {
        value,
        position
      } = this.getActiveHighlight(this.activeHighlight);
      let x = 0;
      let y = 0;
      if (axisCtx.direction === 'x') {
        x = position;
  ...
  getActiveHighlight(activeHighlight) {
    ...
    if (aggregatedValue !== undefined && ((_a = series.axes.y) === null || _a === void 0 ? void 0 : _a.id) === axisCtx.axisId) {
      return {
        ...
        position: axisCtx.scaleConvert(aggregatedValue) + halfBandwidth
      };
    }
    ...
    if (cumulativeValue !== undefined && isYValue) {
      return {
        ...
        position: axisCtx.scaleConvert(cumulativeValue) + halfBandwidth
      };
    }
...
__decorate([Validate(BOOLEAN)], Crosshair.prototype, "enabled", void 0);
...
__decorate([Validate(POSITIVE_NUMBER)], Crosshair.prototype, "lineDashOffset", void 0);
__decorate([Validate(POSITIVE_NUMBER)], Crosshair.prototype, "strokeWidth", void 0);
__decorate([Validate(RATIO)], Crosshair.prototype, "strokeOpacity", void 0);
__decorate([Validate(BOOLEAN)], Crosshair.prototype, "snap", void 0);