...
__decorate([Validate(MIN_SPACING), Default(NaN)], AngleNumberAxisTick.prototype, "maxSpacing", void 0);
...
__decorate([Validate(AND(NUMBER_OR_NAN, LESS_THAN('max'))), Default(NaN)], AngleNumberAxis.prototype, "min", void 0);
__decorate([Validate(AND(NUMBER_OR_NAN, GREATER_THAN('min'))), Default(NaN)], AngleNumberAxis.prototype, "max", void 0);