...
import { _ModuleSupport, _Scale } from '@/components/zing-grid/zing-charts-community/main.js';
...
__decorate([Validate(RATIO)], RadiusCategoryAxis.prototype, "groupPaddingInner", void 0);
__decorate([ProxyPropertyOnWrite('scale', 'paddingInner'), Validate(RATIO)], RadiusCategoryAxis.prototype, "paddingInner", void 0);
__decorate([ProxyPropertyOnWrite('scale', 'paddingOuter'), Validate(RATIO)], RadiusCategoryAxis.prototype, "paddingOuter", void 0);