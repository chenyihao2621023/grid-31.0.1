...
export const RADAR_LINE_CIRCLE_CROSSLINES = {
    options: Object.assign(Object.assign({}, sharedOptions), { series: [
            {
                type: 'radar-line',
                radiusKey: 'software',
                radiusName: 'Software',
...
export const RADIAL_BAR_CIRCLE_CROSSLINES = {
    options: Object.assign(Object.assign({}, sharedOptions), { data: DATA_REVENUE_BY_PRODUCT_CATEGORY.slice(4), series: [
            {
                type: 'radial-bar',
                radiusKey: 'quarter',
                angleKey: 'software',
