...
__decorate([Validate(POSITIVE_NUMBER)], PolarCrossLineLabel.prototype, "fontSize", void 0);
__decorate([Validate(STRING)], PolarCrossLineLabel.prototype, "fontFamily", void 0);
__decorate([Validate(NUMBER)], PolarCrossLineLabel.prototype, "padding", void 0);
...
export class PolarCrossLine {
  constructor() {
    ...
    this.group = new Group({
      name: `${this.id}`,
      layer: true,
      zIndex: PolarCrossLine.LINE_LAYER_ZINDEX
    });
    this.labelGroup = new Group({
      name: `${this.id}`,
      layer: true,
      zIndex: PolarCrossLine.LABEL_LAYER_ZINDEX
    });
  }
  calculatePadding() {}
