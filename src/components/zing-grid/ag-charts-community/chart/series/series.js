...
export class Series extends Observable {
    ...
    constructor(seriesOpts) {
        ...
        const { moduleCtx, useLabelLayer = false, pickModes = [SeriesNodePickMode.NEAREST_BY_MAIN_AXIS_FIRST], directionKeys = {}, directionNames = {}, contentGroupVirtual = true, canHaveAxes = false, } = seriesOpts;
        this.ctx = moduleCtx;
    ...
    get nodeDataDependencies() {
        var _a;
        return (_a = this._nodeDataDependencies) !== null && _a !== void 0 ? _a : { seriesRectWidth: NaN, seriesRectHeight: NaN };
    }
    checkResize(newSeriesRect) {
        const { width: seriesRectWidth, height: seriesRectHeight } = newSeriesRect !== null && newSeriesRect !== void 0 ? newSeriesRect : { width: NaN, height: NaN };
