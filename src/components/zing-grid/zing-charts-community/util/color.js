...
export class Color {
    ...
    static OKLCHtoRGB(l, c, h) {
        ...
        const LMS0 = Math.pow((OKLAB0 + 0.3963377774 * OKLAB1 + 0.2158037573 * OKLAB2), 3);
        const LMS1 = Math.pow((OKLAB0 - 0.1055613458 * OKLAB1 - 0.0638541728 * OKLAB2), 3);
        const LMS2 = Math.pow((OKLAB0 - 0.0894841775 * OKLAB1 - 1.291485548 * OKLAB2), 3);
