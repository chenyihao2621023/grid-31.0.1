...
const drawCorner = (path, { x0, y0, x1, y1, cx, cy }, cornerRadius, move) => {
    if (move) {
        path.moveTo(x0, y0);
    }
    if (x0 !== x1 || y0 !== y1) {
...
export class Rect extends Path {
    ...
    updatePath() {
        var _a, _b, _c;
        const { path, borderPath, crisp, topLeftCornerRadius, topRightCornerRadius, bottomRightCornerRadius, bottomLeftCornerRadius, } = this;
        ...
        if (crisp) {
            ...
            cornerRadiusBbox =
                cornerRadiusBbox != null
                    ? new BBox(this.align(cornerRadiusBbox.x), this.align(cornerRadiusBbox.y), this.align(cornerRadiusBbox.x, cornerRadiusBbox.width), this.align(cornerRadiusBbox.y, cornerRadiusBbox.height))
                    : undefined;
        }
        if (strokeWidth) {
            if (w < pixelSize) {
...
__decorate([
    ScenePathChangeDetection()
], Rect.prototype, "topLeftCornerRadius", void 0);
__decorate([
    ScenePathChangeDetection()
], Rect.prototype, "topRightCornerRadius", void 0);
__decorate([
    ScenePathChangeDetection()
], Rect.prototype, "bottomRightCornerRadius", void 0);
__decorate([
    ScenePathChangeDetection()
], Rect.prototype, "bottomLeftCornerRadius", void 0);
__decorate([
    ScenePathChangeDetection()
], Rect.prototype, "cornerRadiusBbox", void 0);
__decorate([
    ScenePathChangeDetection()
