...
export const EXAMPLES = Object.entries(COMMUNITY_AND_ENTERPRISE_EXAMPLES).filter(([, v]) => !v.enterprise).reduce((pv, [k, v]) => {
  pv[k] = v;
  return pv;
}, {});