...
function addToString(_a) {
    var { value } = _a, others = __rest(_a, ["value"]);
...
const COLUMN_BASIC = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
        },
...
const COLUMN_STACKED = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
        },
...
const COLUMN_STACKED_NORMALISED = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
        },
...
const BAR_BASIC = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'left',
        },
...
const BAR_STACKED = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'left',
        },
...
const BAR_STACKED_NORMALISED = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'left',
        },
...
const COMMON_POLAR = Object.assign(Object.assign({}, COMMON), { data: [
        {
            age: 18,
            gold: 0,
            silver: 1,
...
const PIE_BASIC = Object.assign(Object.assign({}, COMMON_POLAR), { series: [
        {
            type: 'pie',
            angleKey: 'gold',
            angleName: 'Gold',
...
const DOUGHNUT_BASIC = Object.assign(Object.assign({}, COMMON_POLAR), { series: [
        {
            type: 'pie',
            angleKey: 'gold',
            angleName: 'Gold',
...
const LINE_BASIC = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
        },
...
const SCATTER_BASIC = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'number',
            position: 'bottom',
        },
...
const BUBBLE_BASIC = Object.assign(Object.assign({}, COMMON), { series: [
        {
            type: 'bubble',
            xKey: 'gold',
            xName: 'Gold',
...
const AREA_BASIC = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
        },
...
const AREA_STACKED = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
        },
...
const AREA_STACKED_NORMALISED = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
        },
...
const HISTOGRAM = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'number',
            position: 'bottom',
        },
...
const COMBO_LINE = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
            gridLine: {
...
const COMBO_AREA = Object.assign(Object.assign({}, COMMON), { axes: [
        {
            type: 'category',
            position: 'bottom',
            gridLine: {
...
const CROSSFILTER_BAR = Object.assign(Object.assign({}, CROSSFILTER_COMMON), { theme: {
        baseTheme: {
...
const CROSSFILTER_COLUMN = Object.assign(Object.assign({}, CROSSFILTER_COMMON), { theme: {
        baseTheme: {
            baseTheme: CROSSFILTER_THEME,
            overrides: {
                common: {
...
const CROSSFILTER_PIE_FILTERED = Object.assign(Object.assign({}, CROSSFILTER_COMMON), { theme: {
        baseTheme: {
            baseTheme: CROSSFILTER_THEME,
            overrides: {
                common: {
...
const CROSSFILTER_BAR_FILTERED = Object.assign(Object.assign({}, CROSSFILTER_BAR), { data: [
        {
            handset: addToString({
                id: 0,
                value: 'Apple iPhone 12',
...
const CROSSFILTER_COLUMN_FILTERED = Object.assign(Object.assign({}, CROSSFILTER_COLUMN), { data: [
        {
            quarter: addToString({
                id: 0,
                value: 'Q1',
