...
export const CANVAS_TO_BUFFER_DEFAULTS = {
  compressionLevel: 6,
  filters: new Canvas(0, 0).PNG_NO_FILTERS
};
...
export function prepareTestOptions(options, container = document.body) {
  ...
  if (typeof (options === null || options === void 0 ? void 0 : options.theme) === 'object' && (options === null || options === void 0 ? void 0 : options.theme.palette) != null) {
    ...
    baseTestTheme = Object.assign(Object.assign({}, options.theme), {
...
export function hoverAction(x, y) {
  return chartOrProxy => __awaiter(this, void 0, void 0, function* () {
    ...
    target === null || target === void 0 ? void 0 : target.dispatchEvent(mouseMoveEvent({
      offsetX: x - 1,
      offsetY: y - 1
    }));
    target === null || target === void 0 ? void 0 : target.dispatchEvent(mouseMoveEvent({
...
export function doubleClickAction(x, y) {
  return chartOrProxy => __awaiter(this, void 0, void 0, function* () {
    ...
    target === null || target === void 0 ? void 0 : target.dispatchEvent(doubleClickEvent({
      offsetX: x,
      offsetY: y
    }));
    return delay(50);
...
export function scrollAction(x, y, delta) {
  return chartOrProxy => __awaiter(this, void 0, void 0, function* () {
    const chart = deproxy(chartOrProxy);
    const target = chart.scene.canvas.element;
    target === null || target === void 0 ? void 0 : target.dispatchEvent(wheelEvent({
      clientX: x,
      clientY: y,
      deltaY: delta
    }));
...
export function toMatchImage(actual, expected, {
  ...
  const result = pixelmatch(actual, expected, diff.data, width, height, {
    threshold: 0.01
  });
  ...
  return {
    message: () => `Images were ${result} (${diffPercentage.toFixed(2)}%) pixels different`,
    pass
  };
}
...
export function reverseAxes(opts, reverse) {
  ...
  return Object.assign(Object.assign({}, opts), {
    axes: (_a = opts.axes) === null || _a === void 0 ? void 0 : _a.map(axis => Object.assign(Object.assign({}, axis), {
      reverse
    }))
  });
}
export function mixinReversedAxesCases(baseCases) {
  ...
  Object.entries(baseCases).forEach(([name, baseCase]) => {
    result[name + '_REVERSED_AXES'] = Object.assign(Object.assign({}, baseCase), {
