...
export class BaseLayoutProcessor {
  constructor(chartLike, layoutService) {
    ...
    this.destroyFns = [];
    this.destroyFns.push(this.layoutService.addListener('layout-complete', e => this.layoutComplete(e)), this.layoutService.addListener('start-layout', e => this.positionPadding(e.shrinkRect)), this.layoutService.addListener('start-layout', e => this.positionCaptions(e.shrinkRect)));
  }
  destroy() {
