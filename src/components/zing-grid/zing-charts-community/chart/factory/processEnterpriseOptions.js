...
export function removeUsedEnterpriseOptions(options) {
  ...
  if (usedOptions.length > 0) {
    Logger.warnOnce([`unable to use these enterprise features as 'zing-charts-enterprise' has not been loaded:`, ``, ...usedOptions, ``, 'See: https://charts.zing-grid.com/javascript/installation/'].join('\n'));
  }
}