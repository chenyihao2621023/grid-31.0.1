...
export class Axis {
  ...
  wrapLabels(tickData, index, labelProps) {
    ...
    tickData.ticks.forEach(tickDatum => {
      const {
        text
      } = Text.wrap(tickDatum.tickLabel, maxWidth !== null && maxWidth !== void 0 ? maxWidth : defaultMaxWidth, maxHeight !== null && maxHeight !== void 0 ? maxHeight : defaultMaxHeight, labelProps, 'hyphenate');
...
__decorate([Validate(STRING_ARRAY)], Axis.prototype, "keys", void 0);
__decorate([Validate(predicateWithMessage(title => typeof title == 'object', 'Title object'), {
  optional: true
