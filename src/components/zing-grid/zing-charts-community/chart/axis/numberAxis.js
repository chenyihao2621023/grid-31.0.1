...
__decorate([Validate(OR(AND(NUMBER.restrict({
  min: 1
}), GREATER_THAN('minSpacing')), NAN)), Default(NaN)], NumberAxisTick.prototype, "maxSpacing", void 0);
...
__decorate([Validate(AND(NUMBER_OR_NAN, LESS_THAN('max'))), Default(NaN)], NumberAxis.prototype, "min", void 0);
__decorate([Validate(AND(NUMBER_OR_NAN, GREATER_THAN('min'))), Default(NaN)], NumberAxis.prototype, "max", void 0);