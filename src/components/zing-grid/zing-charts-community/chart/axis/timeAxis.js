...
const MAX_SPACING = OR(AND(NUMBER.restrict({
  min: 1
...
__decorate([Validate(MAX_SPACING), Default(NaN)], TimeAxisTick.prototype, "maxSpacing", void 0);
...
TimeAxis.type = 'time';
__decorate([Validate(AND(DATE_OR_DATETIME_MS, LESS_THAN('max')), {
  optional: true
})], TimeAxis.prototype, "min", void 0);
__decorate([Validate(AND(DATE_OR_DATETIME_MS, GREATER_THAN('min')), {
  optional: true
