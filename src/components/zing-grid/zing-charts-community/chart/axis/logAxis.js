...
LogAxis.type = 'log';
__decorate([Validate(AND(NUMBER_OR_NAN, NON_ZERO_NUMBER, LESS_THAN('max'))), Default(NaN)], LogAxis.prototype, "min", void 0);
__decorate([Validate(AND(NUMBER_OR_NAN, NON_ZERO_NUMBER, GREATER_THAN('min'))), Default(NaN)], LogAxis.prototype, "max", void 0);