...
export class Caption extends BaseProperties {
    ...
    computeTextWrap(containerWidth, containerHeight) {
        ...
        const { text: wrappedText, truncated } = Text.wrap(text !== null && text !== void 0 ? text : '', maxWidth, maxHeight, this, wrapping);
    ...
    handleMouseMove(moduleCtx, event) {
        ...
        moduleCtx.tooltipManager.updateTooltip(this.id, { pageX, pageY, offsetX, offsetY, event, showArrow: false, addCustomClass: false }, toTooltipHtml({ content: this.text }));
    }
}
...
__decorate([
    ...
    ProxyPropertyOnWrite('node')
], Caption.prototype, "textAlign", void 0);
__decorate([
