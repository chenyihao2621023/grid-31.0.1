...
__decorate([
    Validate(OBJECT)
], HighlightStyle.prototype, "item", void 0);
__decorate([
    Validate(OBJECT)
], HighlightStyle.prototype, "series", void 0);
__decorate([
    Validate(OBJECT)
], HighlightStyle.prototype, "text", void 0);
...
__decorate([
    Validate(BOOLEAN)
], SeriesProperties.prototype, "visible", void 0);
__decorate([
    Validate(BOOLEAN)
], SeriesProperties.prototype, "showInLegend", void 0);
__decorate([
    Validate(STRING)
], SeriesProperties.prototype, "cursor", void 0);
__decorate([
    Validate(INTERACTION_RANGE)
], SeriesProperties.prototype, "nodeClickRange", void 0);
__decorate([
    Validate(OBJECT)
