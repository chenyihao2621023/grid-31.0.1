...
export class PieSeries extends PolarSeries {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (radiusKey) {
        extraProps.push(rangedValueProperty(this, radiusKey, {
          ...
          id: 'radiusValue'
        }, [0, 1], 1, (_b = this.properties.radiusMin) !== null && _b !== void 0 ? _b : 0, this.properties.radiusMax));
      }
      if (calloutLabelKey) {
  ...
  createNodeData() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.zerosumInnerRing.visible = sum === 0 && this.properties.innerRadiusRatio !== 1 && this.properties.innerRadiusRatio > 0;
      return [{
        itemId: seriesId,
        nodeData,
        labelData: nodeData
  ...
  getSectorFormat(datum, formatIndex, highlight) {
    ...
    const {
      ...
      stroke: sectorSpacing != null ? strokes.length > 0 ? strokes[formatIndex % strokes.length] : undefined : strokes.length > 0 ? strokes[formatIndex % strokes.length] : __BACKGROUND_COLOR_DO_NOT_USE,
  ...
  updateNodes(seriesRect) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const updateSectorFn = (sector, datum, _index, isDatumHighlighted) => {
        ...
        sector.inset = this.properties.sectorSpacing != null ? (this.properties.sectorSpacing + (format.stroke != null ? format.strokeWidth : 0)) / 2 : 0;
  ...
  toggleOtherSeriesItems(series, itemId, enabled) {
    ...
    const datumToggledLegendItemValue = series.properties.legendItemKey && ((_a = series.data) === null || _a === void 0 ? void 0 : _a.find((_, index) => index === itemId)[series.properties.legendItemKey]);
