...
const _q = loadExampleOptions('line-with-gaps'),
  {
    axes
  } = _q,
  LINE_WITH_GAPS_EXAMPLE = __rest(_q, ["axes"]);
...
const columnSeriesLabelFormatter = ({
  value
...
export const COLUMN_SERIES_LABELS = {
  ...
  series: [{
    ...
    yKey: 'iphone',
    label: {
      formatter: columnSeriesLabelFormatter
    }
  }]
};
...
export const GROUPED_AREA_SERIES_LABELS = Object.assign(Object.assign({}, GROUPED_AREA_EXAMPLE), {
  series: [...((_b = (_a = GROUPED_AREA_EXAMPLE.series) === null || _a === void 0 ? void 0 : _a.slice(0, 3).map(s => {
...
export const LINE_SERIES_LABELS = Object.assign(Object.assign({}, LINE_WITH_GAPS_EXAMPLE), {
  series: [...((_d = (_c = LINE_WITH_GAPS_EXAMPLE.series) === null || _c === void 0 ? void 0 : _c.slice(0, 3).map(s => {
    return Object.assign(Object.assign({}, s), {
      label: {
        enabled: true
      }
...
export const HISTOGRAM_SERIES_LABELS = Object.assign(Object.assign({}, HISTOGRAM_EXAMPLE), {
  series: [...((_f = (_e = HISTOGRAM_EXAMPLE.series) === null || _e === void 0 ? void 0 : _e.map(s => Object.assign(Object.assign({}, s), {
    label: {
      enabled: true
    }
  }))) !== null && _f !== void 0 ? _f : [])]
});
export const SCATTER_SERIES_LABELS = Object.assign(Object.assign({}, SCATTER_EXAMPLE), {
  series: [...((_h = (_g = SCATTER_EXAMPLE.series) === null || _g === void 0 ? void 0 : _g.map(s => {
    return Object.assign(Object.assign({}, s), {
      labelKey: 'team',
      label: {
        enabled: true
...
export const GROUPED_SCATTER_SERIES_LABELS = Object.assign(Object.assign({}, GROUPED_LINE_EXAMPLE), {
  series: [...((_k = (_j = GROUPED_LINE_EXAMPLE.series) === null || _j === void 0 ? void 0 : _j.map(s => Object.assign(Object.assign({}, s), {
    type: 'scatter',
    labelKey: 'magnitude',
    label: {
      enabled: true
...
export const BUBBLE_SERIES_LABELS = Object.assign(Object.assign({}, BUBBLE_EXAMPLE), {
  series: [...((_m = (_l = BUBBLE_EXAMPLE.series) === null || _l === void 0 ? void 0 : _l.map(s => {
    return Object.assign(Object.assign({}, s), {
      labelKey: 'city',
      label: {
        enabled: true
...
export const DOUGHNUT_SERIES_LABELS = Object.assign(Object.assign({}, DOUGHNUT_EXAMPLE), {
  series: [...((_p = (_o = DOUGHNUT_EXAMPLE.series) === null || _o === void 0 ? void 0 : _o.map(s => {
    return Object.assign(Object.assign({}, s), {
      calloutLabel: {
        enabled: true
      }
