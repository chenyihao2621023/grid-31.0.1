...
export const DATA_TREEMAP = convertGridTreeData(rowData);
function convertGridTreeData(ds) {
    const root = {};
    ds.forEach((row) => {
    ...
    pathParts.forEach((pathPart, partIndex) => {
        ...
        if (!root) {
            if (partIndex === lastPartIndex) {
                children.push(Object.assign(Object.assign({}, row), { [pathFieldName]: pathPart }));
            }
            else {
