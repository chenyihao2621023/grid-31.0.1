...
const CROSSLINE_LABEL_POSITION = UNION(['top', 'left', 'right', 'bottom', 'topLeft', 'topRight', 'bottomLeft', 'bottomRight', 'inside', 'insideLeft', 'insideRight', 'insideTop', 'insideBottom', 'insideTopLeft', 'insideBottomLeft', 'insideTopRight', 'insideBottomRight'], 'crossLine label position');
...
__decorate([Validate(POSITIVE_NUMBER)], CartesianCrossLineLabel.prototype, "fontSize", void 0);
__decorate([Validate(STRING)], CartesianCrossLineLabel.prototype, "fontFamily", void 0);
__decorate([Validate(NUMBER)], CartesianCrossLineLabel.prototype, "padding", void 0);
__decorate([Validate(COLOR_STRING, {
  optional: true
})], CartesianCrossLineLabel.prototype, "color", void 0);
__decorate([Validate(CROSSLINE_LABEL_POSITION, {
  optional: true
...
export class CartesianCrossLine {
  constructor() {
    ...
    this.labelGroup = new Group({
      name: `${this.id}`,
      layer: true,
      zIndex: CartesianCrossLine.LABEL_LAYER_ZINDEX
    });
  ...
  update(visible) {
    ...
    if (!type || !scale || !enabled || !visible || !validateCrossLineValues(type, value, range, scale) || data.length === 0) {
  ...
  createNodeData(reversedAxis) {
    ...
    if (this.label.enabled) {
      ...
      } = (_c = labelDirectionHandling[position]) !== null && _c !== void 0 ? _c : {};
      const {
        x: labelX,
        y: labelY
      } = c({
...
__decorate([Validate(UNION(['range', 'line'], 'a crossLine type'), {
  optional: true
})], CartesianCrossLine.prototype, "type", void 0);
__decorate([Validate(AND(MATCHING_CROSSLINE_TYPE('range'), ARRAY.restrict({
  length: 2
})), {
  optional: true
})], CartesianCrossLine.prototype, "range", void 0);
__decorate([Validate(MATCHING_CROSSLINE_TYPE('value'), {
  optional: true
