...
const createChartOptions = rangeConfig => {
  ...
  for (const name in rangeConfig) {
    result[name] = Object.assign(Object.assign({}, baseChartOptions), {
      axes: (_a = baseChartOptions['axes']) === null || _a === void 0 ? void 0 : _a.map(axis => {
        const range = axis.position === 'bottom' ? rangeConfig[name].vertical : rangeConfig[name].horizontal;
        return Object.assign(Object.assign({}, axis), {
          crossLines: [Object.assign(Object.assign({}, baseCrossLineOptions), {
            range
          })]
        });
      })
...
const createChartOptionsWithInvalidCrossLines = config => {
  ...
  for (const name in config) {
    ...
    result[name] = Object.assign(Object.assign({}, baseChartOptions), {
      axes: (_a = baseChartOptions['axes']) === null || _a === void 0 ? void 0 : _a.map(axis => {
        return axis.position === 'left' ? Object.assign(Object.assign({}, axis), {
          crossLines: [Object.assign(Object.assign(Object.assign({}, baseCrossLineOptions), {
            type: undefined
          }), invalidCrossLineOptions)]
        }) : axis;
      })
    });
  }
...
export const SCATTER_CROSSLINES = {
  ...
  axes: [{
    ...
    }, yAxisCrossLineStyle), Object.assign({
      type: 'line',
      value: 60,
      label: {
        text: '60',
    ...
    }, xAxisCrossLineStyle), Object.assign({
      type: 'range',
      range: [2013, 2014],
      label: {
        text: '2013 - 20014'
...
export const LINE_CROSSLINES = Object.assign(Object.assign({}, LINE_GRAPH_WITH_GAPS_EXAMPLE), {
  axes: [{
    type: 'category',
    position: 'bottom',
    title: {
...
export const AREA_CROSSLINES = Object.assign(Object.assign({}, AREA_GRAPH_WITH_NEGATIVE_VALUES_EXAMPLE), {
  axes: [{
    type: 'category',
    position: 'bottom',
    crossLines: [Object.assign({
...
export const COLUMN_CROSSLINES = Object.assign(Object.assign({}, GROUPED_COLUMN_EXAMPLE), {
  axes: [{
    position: 'bottom',
    type: 'category',
    crossLines: [Object.assign({
...
export const BAR_CROSSLINES = Object.assign(Object.assign({}, GROUPED_BAR_CHART_EXAMPLE), {
  axes: [{
    position: 'left',
    type: 'category',
    crossLines: [Object.assign({
...
export const HISTOGRAM_CROSSLINES = Object.assign(Object.assign({}, XY_HISTOGRAM_WITH_MEAN_EXAMPLE), {
  axes: [{
    position: 'bottom',
    type: 'number',
    title: {
