...
export class CartesianChart extends Chart {
    ...
    updateAxes(inputShrinkRect) {
        ...
        const crossLineIds = this.axes.flatMap((axis) => { var _a; return (_a = axis.crossLines) !== null && _a !== void 0 ? _a : []; }).map((crossLine) => crossLine.id);
        const axesValid = this._lastCrossLineIds != null &&
