...
export class PageSizeSelectorComp extends Component {
  ...
  reloadPageSizesSelector() {
    ...
    this.selectPageSizeComp = this.createManagedBean(new ZingSelect()).addOptions(options).setValue(String(shouldAddAndSelectEmptyOption ? '' : paginationPageSizeOption)).setAriaLabel(localisedAriaLabel).setLabel(localisedLabel).onValueChange(() => this.handlePageSizeItemSelected());
...
__decorate([Autowired('localeService')], PageSizeSelectorComp.prototype, "localeService", void 0);
__decorate([Autowired('gridOptionsService')], PageSizeSelectorComp.prototype, "gridOptionsService", void 0);
__decorate([Autowired('paginationProxy')], PageSizeSelectorComp.prototype, "paginationProxy", void 0);
__decorate([PostConstruct], PageSizeSelectorComp.prototype, "init", null);