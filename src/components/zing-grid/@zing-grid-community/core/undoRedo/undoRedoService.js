...
let UndoRedoService = class UndoRedoService extends BeanStub {
  ...
  setLastFocusedCell(lastFocusedCell, setRangeToCell) {
    ...
    this.focusService.setFocusedCell(Object.assign(Object.assign({}, cellPosition), {
...
__decorate([Autowired('ctrlsService')], UndoRedoService.prototype, "ctrlsService", void 0);
...
__decorate([Autowired('columnModel')], UndoRedoService.prototype, "columnModel", void 0);
__decorate([Optional('rangeService')], UndoRedoService.prototype, "rangeService", void 0);
