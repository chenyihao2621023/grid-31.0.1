...
__decorate([Autowired('rowModel')], ExpansionService.prototype, "rowModel", void 0);
__decorate([PostConstruct], ExpansionService.prototype, "postConstruct", null);
ExpansionService = __decorate([Bean('expansionService')], ExpansionService);
