...
let StateService = class StateService extends BeanStub {
  ...
  setupStateOnRowCountReady() {
    ...
    } = (_a = this.gridOptionsService.get('initialState')) !== null && _a !== void 0 ? _a : {};
  ...
  getColumnState() {
    ...
    for (let i = 0; i < columnState.length; i++) {
      ...
      columns.push(colId);
      if (sort) {
        sortColumns[sortIndex !== null && sortIndex !== void 0 ? sortIndex : 0] = {
          colId,
          sort
        };
      }
    ...
    return {
      ...
      rowGroup: groupColumns.length ? {
        groupColIds: groupColumns
      } : undefined,
      aggregation: aggregationColumns.length ? {
        aggregationModel: aggregationColumns
      } : undefined,
      pivot: pivotColumns.length || pivotMode ? {
        pivotMode,
        pivotColIds: pivotColumns
      } : undefined,
      columnPinning: leftColumns.length || rightColumns.length ? {
        leftColIds: leftColumns,
        rightColIds: rightColumns
      } : undefined,
  ...
  setFilterState(filterState, gridOptionAdvancedFilterModel) {
    const {
      filterModel,
      advancedFilterModel
    } = filterState !== null && filterState !== void 0 ? filterState : {
  ...
  getRangeSelectionState() {
    ...
    return (cellRanges === null || cellRanges === void 0 ? void 0 : cellRanges.length) ? {
      cellRanges
    } : undefined;
  }
  setRangeSelectionState(rangeSelectionState) {
    ...
    const cellRanges = rangeSelectionState.cellRanges.map(cellRange => Object.assign(Object.assign({}, cellRange), {
  ...
  getScrollState() {
    ...
    const {
      left
    } = (_b = scrollFeature === null || scrollFeature === void 0 ? void 0 : scrollFeature.getHScrollPosition()) !== null && _b !== void 0 ? _b : {
      left: 0
    };
    const {
      top
    } = (_c = scrollFeature === null || scrollFeature === void 0 ? void 0 : scrollFeature.getVScrollPosition()) !== null && _c !== void 0 ? _c : {
      top: 0
    };
    return top || left ? {
      top,
  ...
  getPaginationState() {
    ...
    const pageSize = !this.gridOptionsService.get('paginationAutoPageSize') ? this.paginationProxy.getPageSize() : undefined;
    if (!page && !pageSize) {
      return;
    }
    return {
  ...
  getRowSelectionState() {
    ...
    const noSelections = !selectionState || !Array.isArray(selectionState) && (selectionState.selectAll === false || selectionState.selectAllChildren === false) && !((_a = selectionState === null || selectionState === void 0 ? void 0 : selectionState.toggledNodes) === null || _a === void 0 ? void 0 : _a.length);
  ...
  updateCachedState(key, value) {
    ...
    this.cachedState = Object.assign(Object.assign({}, this.cachedState), {
      [key]: value
    });
...
__decorate([Autowired('filterManager')], StateService.prototype, "filterManager", void 0);
__decorate([Optional('rangeService')], StateService.prototype, "rangeService", void 0);
__decorate([Autowired('ctrlsService')], StateService.prototype, "ctrlsService", void 0);
__decorate([Optional('sideBarService')], StateService.prototype, "sideBarService", void 0);
__decorate([Autowired('focusService')], StateService.prototype, "focusService", void 0);
__decorate([Autowired('columnModel')], StateService.prototype, "columnModel", void 0);
__decorate([Autowired('paginationProxy')], StateService.prototype, "paginationProxy", void 0);
__decorate([Autowired('rowModel')], StateService.prototype, "rowModel", void 0);
__decorate([Autowired('selectionService')], StateService.prototype, "selectionService", void 0);
__decorate([Autowired('expansionService')], StateService.prototype, "expansionService", void 0);
__decorate([PostConstruct], StateService.prototype, "postConstruct", null);
StateService = __decorate([Bean('stateService')], StateService);
export { StateService };