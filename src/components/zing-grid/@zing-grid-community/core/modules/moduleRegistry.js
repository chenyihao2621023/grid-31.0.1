...
export class ModuleRegistry {
  ...
  static __assertRegistered(moduleName, reason, gridId) {
    ...
    if (ModuleRegistry.isBundled) {
      {
        warningMessage = `ZING Grid: unable to use ${reason} as 'zing-grid-enterprise' has not been loaded. Check you are using the Enterprise bundle:
...
For more info see: https://zing-grid.com/javascript-data-grid/getting-started/#getting-started-with-zing-grid-enterprise`;
      ...
      warningMessage = `ZING Grid: unable to use ${reason} as the ${modName} is not registered${ModuleRegistry.areGridScopedModules ? ` for gridId: ${gridId}` : ''}. Check if you have registered the module:
...
For more info see: https://www.zing-grid.com/javascript-grid/modules/`;
      ...
      warningMessage = `ZING Grid: unable to use ${reason} as package 'zing-grid-enterprise' has not been imported. Check that you have imported the package:
