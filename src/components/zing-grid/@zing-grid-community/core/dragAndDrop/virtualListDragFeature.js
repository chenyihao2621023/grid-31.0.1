...
export class VirtualListDragFeature extends BeanStub {
  ...
  clearHoveredItems() {
    ...
    virtualListGui.querySelectorAll(`.${LIST_ITEM_HOVERED}`).forEach(el => {
      [LIST_ITEM_HOVERED, 'zing-item-highlight-top', 'zing-item-highlight-bottom'].forEach(cls => {
...
__decorate([Autowired('dragAndDropService')], VirtualListDragFeature.prototype, "dragAndDropService", void 0);
__decorate([PostConstruct], VirtualListDragFeature.prototype, "postConstruct", null);