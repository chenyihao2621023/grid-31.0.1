...
let QuickFilterService = QuickFilterService_1 = class QuickFilterService extends BeanStub {
  ...
  setQuickFilter(newFilter) {
    ...
    if (this.quickFilter !== parsedFilter) {
      ...
      this.setQuickFilterParts();
      this.dispatchEvent({
        type: QuickFilterService_1.EVENT_QUICK_FILTER_CHANGED
      });
    }
  }
...
__decorate([Autowired('valueService')], QuickFilterService.prototype, "valueService", void 0);
__decorate([Autowired('columnModel')], QuickFilterService.prototype, "columnModel", void 0);
__decorate([Autowired('rowModel')], QuickFilterService.prototype, "rowModel", void 0);
__decorate([PostConstruct], QuickFilterService.prototype, "postConstruct", null);
QuickFilterService = QuickFilterService_1 = __decorate([Bean('quickFilterService')], QuickFilterService);
