...
__decorate([Autowired('gridOptions')], ValidationService.prototype, "gridOptions", void 0);
__decorate([PostConstruct], ValidationService.prototype, "init", null);
ValidationService = __decorate([Bean('validationService')], ValidationService);
