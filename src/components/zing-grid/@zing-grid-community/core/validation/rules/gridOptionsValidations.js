...
const GRID_OPTION_VALIDATIONS = {
  sideBar: {
    module: ModuleNames.SideBarModule
  },
  statusBar: {
    module: ModuleNames.StatusBarModule
  },
  enableCharts: {
    module: ModuleNames.GridChartsModule
  },
  getMainMenuItems: {
  ...
  enableAdvancedFilter: {
    module: ModuleNames.AdvancedFilterModule
  },
  treeData: {
  ...
  masterDetail: {
    module: ModuleNames.MasterDetailModule
  },
