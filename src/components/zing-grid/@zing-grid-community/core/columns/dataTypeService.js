...
let DataTypeService = class DataTypeService extends BeanStub {
  ...
  processDataTypeDefinitions() {
    ...
    Object.entries(defaultDataTypes).forEach(([cellDataType, dataTypeDefinition]) => {
      this.dataTypeDefinitions[cellDataType] = Object.assign(Object.assign({}, dataTypeDefinition), {
  ...
  processDataTypeDefinition(dataTypeDefinition, dataTypeDefinitions, alreadyProcessedDataTypes, defaultDataTypes) {
    ...
    return Object.assign(Object.assign({}, mergedDataTypeDefinition), {
          ...
          if (dataTypeDefinition.baseDataType === 'number' && aggFunc !== 'count') {
            ...
            if (typeof params.value === 'object') {
              ...
              if ('toNumber' in params.value) {
                return dataTypeDefinition.valueFormatter(Object.assign(Object.assign({}, params), {
  ...
  doColDefPropsPreventInference(colDef, propsToCheckForInference) {
    return [['cellRenderer', 'zingSparklineCellRenderer'], ['valueGetter', undefined], ['valueParser', undefined], ['refData', undefined]].some(([prop, comparisonValue]) => this.doesColDefPropPreventInference(colDef, propsToCheckForInference, prop, comparisonValue));
  }
  ...
  getDefaultDataTypes() {
    ...
    return {
      ...
      dateString: {
        ...
        dateParser: value => {
          var _a;
          return (_a = parseDateTimeFromString(value)) !== null && _a !== void 0 ? _a : undefined;
        },
        dateFormatter: value => {
          var _a;
          return (_a = serialiseDate(value !== null && value !== void 0 ? value : null, false)) !== null && _a !== void 0 ? _a : undefined;
        },
...
__decorate([Autowired('rowModel')], DataTypeService.prototype, "rowModel", void 0);
__decorate([Autowired('columnModel')], DataTypeService.prototype, "columnModel", void 0);
__decorate([Autowired('columnUtils')], DataTypeService.prototype, "columnUtils", void 0);
__decorate([Autowired('valueService')], DataTypeService.prototype, "valueService", void 0);
__decorate([Autowired('valueFormatterService')], DataTypeService.prototype, "valueFormatterService", void 0);
__decorate([PostConstruct], DataTypeService.prototype, "init", null);
DataTypeService = __decorate([Bean('dataTypeService')], DataTypeService);
