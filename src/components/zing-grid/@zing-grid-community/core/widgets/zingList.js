...
export class ZingList extends Component {
  ...
  highlightItem(el) {
    ...
    this.highlightedEl.classList.add(ZingList.ACTIVE_CLASS);
  ...
  clearHighlighted() {
    ...
    this.highlightedEl.classList.remove(ZingList.ACTIVE_CLASS);
  ...
  fireItemSelected() {
    this.dispatchEvent({
      type: ZingList.EVENT_ITEM_SELECTED
    });
  }
}
ZingList.EVENT_ITEM_SELECTED = 'selectedItem';
ZingList.ACTIVE_CLASS = 'zing-active-item';
__decorate([PostConstruct], ZingList.prototype, "init", null);