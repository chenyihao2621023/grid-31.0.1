...
export class ZingRichSelect extends ZingPickerField {
  constructor(config) {
    ...
    super(Object.assign(Object.assign({
      ...
      className: 'zing-rich-select',
      pickerIcon: 'smallDown',
      ariaRole: 'combobox',
      template: (_a = config === null || config === void 0 ? void 0 : config.template) !== null && _a !== void 0 ? _a : TEMPLATE,
      modalPicker: false
    }, config), {
...
__decorate([Autowired('userComponentFactory')], ZingRichSelect.prototype, "userComponentFactory", void 0);
__decorate([RefSelector('eInput')], ZingRichSelect.prototype, "eInput", void 0);