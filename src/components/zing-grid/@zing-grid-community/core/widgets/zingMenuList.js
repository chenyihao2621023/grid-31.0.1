...
export class ZingMenuList extends TabGuardComp {
    ...
    addItem(menuItemDef) {
        const menuItem = this.createManagedBean(new ZingMenuItemComponent(Object.assign(Object.assign({}, menuItemDef), { isAnotherSubMenuOpen: () => this.menuItems.some(m => m.isSubMenuOpen()) })));
...
], ZingMenuList.prototype, "focusService", void 0);
__decorate([
    PostConstruct
