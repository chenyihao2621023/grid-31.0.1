...
import { ZingAutocompleteList } from "./zingAutocompleteList";
...
export class ZingAutocomplete extends Component {
  ...
  updateValue(value) {
    ...
    this.dispatchEvent({
      type: ZingAutocomplete.EVENT_VALUE_CHANGED,
      value
    });
    this.validate(value);
  }
  updateAutocompleteList(value) {
    var _a, _b, _c, _d;
    const autocompleteListParams = (_b = (_a = this.listGenerator) === null || _a === void 0 ? void 0 : _a.call(this, value, this.lastPosition)) !== null && _b !== void 0 ? _b : {
      enabled: false
    };
  ...
  confirmSelection() {
    ...
    if (selectedValue) {
      this.closeList();
      this.dispatchEvent({
        type: ZingAutocomplete.EVENT_OPTION_SELECTED,
        value: this.getValue(),
  ...
  validate(value) {
    ...
    this.dispatchEvent({
      type: ZingAutocomplete.EVENT_VALID_CHANGED,
      isValid: this.valid,
  ...
  openList() {
    ...
    this.autocompleteList = this.createBean(new ZingAutocompleteList({
  ...
  onCompleted() {
    ...
    this.dispatchEvent({
      type: ZingAutocomplete.EVENT_VALUE_CONFIRMED,
      value: this.getValue(),
...
ZingAutocomplete.EVENT_VALUE_CHANGED = 'eventValueChanged';
ZingAutocomplete.EVENT_VALUE_CONFIRMED = 'eventValueConfirmed';
ZingAutocomplete.EVENT_OPTION_SELECTED = 'eventOptionSelected';
ZingAutocomplete.EVENT_VALID_CHANGED = 'eventValidChanged';
__decorate([Autowired('popupService')], ZingAutocomplete.prototype, "popupService", void 0);
__decorate([RefSelector('eAutocompleteInput')], ZingAutocomplete.prototype, "eAutocompleteInput", void 0);
__decorate([PostConstruct], ZingAutocomplete.prototype, "postConstruct", null);