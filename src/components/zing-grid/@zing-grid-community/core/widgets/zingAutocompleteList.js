...
import { ZingAutocompleteRow } from "./zingAutocompleteRow";
import { fuzzySuggestions } from "../utils/fuzzyMatch";
import { PopupComponent } from "./popupComponent";
import { PostConstruct } from "../context/context";
import { exists } from "../utils/generic";
export class ZingAutocompleteList extends PopupComponent {
  constructor(params) {
    super(ZingAutocompleteList.TEMPLATE);
    this.params = params;
    this.searchString = '';
  }
  destroy() {
  ...
  runSearch() {
    ...
    const searchStrings = autocompleteEntries.map(v => {
      var _a;
      return (_a = v.displayValue) !== null && _a !== void 0 ? _a : v.key;
    });
    let matchingStrings;
    let topSuggestion;
    ...
    let filteredEntries = autocompleteEntries.filter(({
      key,
      displayValue
    }) => matchingStrings.includes(displayValue !== null && displayValue !== void 0 ? displayValue : key));
  ...
  createRowComponent(value) {
    var _a;
    const row = new ZingAutocompleteRow();
...
ZingAutocompleteList.TEMPLATE = `<div class="zing-autocomplete-list-popup">
        ...
        <div>`;
__decorate([RefSelector('eList')], ZingAutocompleteList.prototype, "eList", void 0);
__decorate([PostConstruct], ZingAutocompleteList.prototype, "init", null);